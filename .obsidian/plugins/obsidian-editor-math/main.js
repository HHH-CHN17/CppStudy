...
var require_lodash = __commonJS({
  "node_modules/lodash/index.js"(exports, module2) {
    (function() {
      var undefined2;
      var VERSION = "3.10.1";
      ...
      function runInContext(context) {
        ...
        function assignOwnDefaults(objectValue, sourceValue, key, object) {
          return objectValue === undefined2 || !hasOwnProperty.call(object, key) ? sourceValue : objectValue;
        }
        ...
        function template(string, options, otherOptions) {
          ...
          if (otherOptions && isIterateeCall(string, options, otherOptions)) {
            options = otherOptions = undefined2;
          }
          string = baseToString(string);
...
// node_modules/codemirror-widgets/lib/utils.js
var require_utils = __commonJS({
  "node_modules/codemirror-widgets/lib/utils.js"(exports, module2) {
    ...
    function rangesOverlap(fromTo1, fromTo2) {
      return posCmp(fromTo1.from, fromTo2.to) < 0 && posCmp(fromTo2.from, fromTo1.to) < 0;
    }
...
// node_modules/codemirror-widgets/lib/manager.js
var require_manager = __commonJS({
  "node_modules/codemirror-widgets/lib/manager.js"(exports, module2) {
    var _ = require_lodash();
    var CodeMirror = require;
    var utils = require_utils();
    function Manager(editor) {
      if (!(this instanceof Manager))
        return new Manager(editor);
      _.bindAll(this);
...
// node_modules/codemirror-widgets/lib/widget.js
var require_widget = __commonJS({
  "node_modules/codemirror-widgets/lib/widget.js"(exports, module2) {
    var _ = require_lodash();
    ...
    module2.exports = Widget;
  }
});

// node_modules/codemirror-widgets/lib/type.js
var require_type = __commonJS({
  "node_modules/codemirror-widgets/lib/type.js"(exports, module2) {
    var _ = require_lodash();
    ...
    WidgetType.prototype.createWidget = function(range, props) {
      ...
      exists = _.find(markers, function(marker) {
        return !marker.unrendered && marker.xType == that.id && that.compareProps(marker.xProps, props);
      });
      if (rejected) {
        if (exists)
          exists.clear();
    ...
    WidgetType.prototype.processMatches = function(from, matches) {
      ...
      that.editor.operation(function() {
        ...
        _.each(matches, function(match) {
          var range = utils.Range(doc.posFromIndex(fromIndex + match.start), doc.posFromIndex(fromIndex + match.end));
    ...
    function createType(type) {
      ...
      CustomType.prototype = utils.composeMixins(CustomType.prototype, (type.mixins || []).concat([type]), {
...
// node_modules/codemirror-widgets/lib/mixins/menu.js
var require_menu = __commonJS({
  "node_modules/codemirror-widgets/lib/mixins/menu.js"(exports, module2) {
    var _ = require_lodash();
    var utils = require_utils();
    module2.exports = function(opts) {
      ...
      return {
        ...
        closeMenu: function(force) {
          if (!this.manager.menu || force !== true && this.manager.ignoreCloseMenu)
            return;
        ...
        openMenu: function(widget, direction) {
          ...
          el.style.float = "left";
          var scrollArea = editor.getWrapperElement().getElementsByClassName("CodeMirror-sizer")[0];
          ...
          if (!_.isUndefined(pos.left))
            el.style.left = pos.left + "px";
          if (!_.isUndefined(pos.right))
            el.style.right = pos.right + "px";
          if (!_.isUndefined(pos.top))
...
// node_modules/codemirror-widgets/lib/mixins/re.js
var require_re = __commonJS({
  "node_modules/codemirror-widgets/lib/mixins/re.js"(exports, module2) {
    module2.exports = function(re, fn) {
      return {
        find: function(text) {
          var matches = [], found;
          re.lastIndex = 0;
...
// node_modules/codemirror-widgets/lib/mixins/edit_paragraph.js
var require_edit_paragraph = __commonJS({
  "node_modules/codemirror-widgets/lib/mixins/edit_paragraph.js"(exports, module2) {
    var _ = require_lodash();
    var utils = require_utils();
    module2.exports = function() {
      return {
        findEditRange: function(range) {
          ...
          return utils.Range(utils.Pos(findParagraph(range.from, -1), 0), utils.Pos(findParagraph(range.to, 1), 0));
        }
      };
    };
  }
...
// node_modules/codemirror-widgets/lib/mixins/reject_tokens.js
var require_reject_tokens = __commonJS({
  "node_modules/codemirror-widgets/lib/mixins/reject_tokens.js"(exports, module2) {
    var _ = require_lodash();
    module2.exports = function(types) {
      return {
        enable: function() {
...
// node_modules/codemirror-widgets/lib/mixins/index.js
var require_mixins = __commonJS({
  "node_modules/codemirror-widgets/lib/mixins/index.js"(exports, module2) {
    module2.exports = {
      menu: require_menu(),
      re: require_re(),
      editParagraph: require_edit_paragraph(),
      rejectTokens: require_reject_tokens()
    };
  }
});

// node_modules/codemirror-widgets/lib/index.js
var require_lib = __commonJS({
  "node_modules/codemirror-widgets/lib/index.js"(exports, module2) {
    module2.exports = {
      createType: require_type().create,
      createManager: require_manager(),
      mixins: require_mixins()
    };
  }
});
...
var import_codemirror_widgets = __toModule(require_lib());
var import_katex = __toModule(require_katex());
var MyPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.handleInitialLoad = (cm) => {
      var WidgetMath = import_codemirror_widgets.default.createType({
        mixins: [
          import_codemirror_widgets.default.mixins.re(/\$\$([^$]+)\$\$/g, function(match) {
            return {
              props: {
                text: match[1]
              }
          ...
          import_codemirror_widgets.default.mixins.editParagraph()
        ],
        createElement: function(widget) {
          var span = document.createElement("span");
          import_katex.default.render(widget.props.text, span);
          return span;
        }
      });
      var manager = import_codemirror_widgets.default.createManager(cm);
